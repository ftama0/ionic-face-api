                ...
                <ion-row>
                    ...
                    <ion-col size="12">
                        <div v-for="(item, index) in items" :key="index">
                            <ion-card>
                                <ion-card-header router-link="/costCenterPrDetail">
                                    <ion-card-title>{{ item.name }}</ion-card-title>
                                </ion-card-header>
                                <ion-card-content router-link="/costCenterPrDetail">
                                    {{ item.description }}
                                    <br>
                                    {{ item.description }}
                                </ion-card-content>
...
import Modal from './VMaintainCostCenterPrModal.vue';
...
const mainContentId = 'cost-center-pr-content';
const search = ref('');
